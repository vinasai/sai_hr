...
const SideBar = () => {
    ...
    return (
      <div className="flex">
        <div
          className={`bg-gray-900 text-white h-screen p-5 w-64 fixed transition-transform duration-300 ${
        ...
        <button className="md:hidden p-3 absolute top-4 left-4 bg-gray-900 text-white rounded-full" onClick={() => setIsOpen(!isOpen)}>
          <Menu size={24} />
        </button>


        <div className="ml-64 md:ml-0 p-6 w-full">
